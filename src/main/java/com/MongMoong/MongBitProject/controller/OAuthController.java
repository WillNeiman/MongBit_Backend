...
public class OAuthController {
    ...
    http://localhost:8100/api/v1/test/649a7bccaa04db61384808c5/648153acc5f9f12b04573de/like
     */
    ...
    public ResponseEntity<KakaoLoginResponse> kakaoLogin(String code, HttpServletRequest request) {
        ...
        boolean isAdmin = tokenProvider.validateTokenAndCheckAdmin(jwtToken);
